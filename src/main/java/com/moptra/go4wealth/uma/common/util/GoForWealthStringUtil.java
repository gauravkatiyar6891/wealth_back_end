...
public class GoForWealthStringUtil {
	/**
	...
	public static boolean isEmpty(Object obj) {
		boolean isEmpty = false;
		if (obj == GoForWealthUMAConstants.BLANK)
			isEmpty = true;
		return isEmpty;
	}
	...
	public static boolean compareListData(List currentList, List availableList)
	{
		...
		else if(GoForWealthUMAUtil.isEmptyCollection(currentList) && GoForWealthUMAUtil.isEmptyCollection(availableList)){
			return true;
		}
		return false;
	}
