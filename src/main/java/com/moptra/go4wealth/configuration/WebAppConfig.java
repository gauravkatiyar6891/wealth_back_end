...
@ComponentScan("com.moptra.go4wealth.bean")
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("com.moptra.go4wealth.repository")
public class WebAppConfig {
    ...
    private Properties jpaProperties() {
      ...
      properties.put(PROPERTY_NAME_HIBERNATE_SHOW_SQL, env.getRequiredProperty(PROPERTY_NAME_HIBERNATE_EJB_NAMING_STRATEGY));
