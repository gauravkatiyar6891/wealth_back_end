...
public class Response {
    ...
    @XmlElementRef(name = "Filler", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    protected JAXBElement<String> filler;
    @XmlElementRef(name = "ResponseString", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
