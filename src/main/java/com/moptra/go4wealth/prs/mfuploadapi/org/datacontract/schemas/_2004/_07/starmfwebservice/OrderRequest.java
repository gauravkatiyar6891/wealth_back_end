...
public class OrderRequest {
    ...
    @XmlElementRef(name = "Filler1", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    protected JAXBElement<String> filler1;
    @XmlElementRef(name = "Filler2", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    protected JAXBElement<String> filler2;
    @XmlElementRef(name = "Filler3", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    protected JAXBElement<String> filler3;
    @XmlElementRef(name = "FromDate", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "Password", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "ToDate", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    protected JAXBElement<String> toDate;
    @XmlElementRef(name = "TransType", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    ...
    public void setFiller3(JAXBElement<String> value) {
        this.filler3 = ((JAXBElement<String> ) value);
    }
    ...
    public void setFromDate(JAXBElement<String> value) {
        this.fromDate = ((JAXBElement<String> ) value);
    }
    ...
    public void setToDate(JAXBElement<String> value) {
        this.toDate = ((JAXBElement<String> ) value);
    }
    ...
    public void setTransType(JAXBElement<String> value) {
        this.transType = ((JAXBElement<String> ) value);
    }
