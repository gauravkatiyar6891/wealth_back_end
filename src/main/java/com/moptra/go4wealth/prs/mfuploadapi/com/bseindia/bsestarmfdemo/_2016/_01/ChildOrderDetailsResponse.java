...
public class ChildOrderDetailsResponse {
    ...
    @XmlElementRef(name = "ChildOrderDetailsResult", namespace = "http://www.bsestarmf.in/2016/01/", type = JAXBElement.class)
    ...
    public void setChildOrderDetailsResult(JAXBElement<ChildOrderResponse> value) {
        this.childOrderDetailsResult = ((JAXBElement<ChildOrderResponse> ) value);
    }
