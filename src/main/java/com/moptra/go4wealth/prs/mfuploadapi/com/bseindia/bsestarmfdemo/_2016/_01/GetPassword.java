...
public class GetPassword {
    ...
    @XmlElementRef(name = "UserId", namespace = "http://www.bsestarmf.in/2016/01/", type = JAXBElement.class)
    protected JAXBElement<String> userId;
    @XmlElementRef(name = "MemberId", namespace = "http://www.bsestarmf.in/2016/01/", type = JAXBElement.class)
    protected JAXBElement<String> memberId;
    @XmlElementRef(name = "Password", namespace = "http://www.bsestarmf.in/2016/01/", type = JAXBElement.class)
    protected JAXBElement<String> password;
    @XmlElementRef(name = "PassKey", namespace = "http://www.bsestarmf.in/2016/01/", type = JAXBElement.class)
