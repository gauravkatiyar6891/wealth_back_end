...
public class ChildOrderRequest {
    ...
    @XmlElementRef(name = "RegnNo", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    protected JAXBElement<String> regnNo;
    @XmlElementRef(name = "SystematicPlanType", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    ...
    public void setRegnNo(JAXBElement<String> value) {
        this.regnNo = ((JAXBElement<String> ) value);
    }
    ...
    public void setSystematicPlanType(JAXBElement<String> value) {
        this.systematicPlanType = ((JAXBElement<String> ) value);
    }
