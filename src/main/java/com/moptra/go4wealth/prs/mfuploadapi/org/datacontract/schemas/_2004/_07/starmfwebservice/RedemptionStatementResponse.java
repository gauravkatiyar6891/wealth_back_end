...
public class RedemptionStatementResponse {
    ...
    @XmlElementRef(name = "RedemptionDetails", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    ...
    public void setRedemptionDetails(JAXBElement<ArrayOfRedemptionDetails> value) {
        this.redemptionDetails = ((JAXBElement<ArrayOfRedemptionDetails> ) value);
    }
