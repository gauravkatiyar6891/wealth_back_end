...
public class ChildOrderResponse {
    ...
    @XmlElementRef(name = "ChildOrderDetails", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    ...
    public void setChildOrderDetails(JAXBElement<ArrayOfChildOrderDetails> value) {
        this.childOrderDetails = ((JAXBElement<ArrayOfChildOrderDetails> ) value);
    }
