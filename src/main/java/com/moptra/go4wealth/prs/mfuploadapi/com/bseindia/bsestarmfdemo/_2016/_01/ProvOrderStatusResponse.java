...
public class ProvOrderStatusResponse {
    ...
    @XmlElementRef(name = "ProvOrderStatusResult", namespace = "http://www.bsestarmf.in/2016/01/", type = JAXBElement.class)
    ...
    public void setProvOrderStatusResult(JAXBElement<ProvOrderResponse> value) {
        this.provOrderStatusResult = ((JAXBElement<ProvOrderResponse> ) value);
    }
