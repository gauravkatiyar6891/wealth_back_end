...
public class ProvOrderResponse {
    ...
    @XmlElementRef(name = "provOrderDetails", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    ...
    public void setProvOrderDetails(JAXBElement<ArrayOfProvOrderDetails> value) {
        this.provOrderDetails = ((JAXBElement<ArrayOfProvOrderDetails> ) value);
    }
