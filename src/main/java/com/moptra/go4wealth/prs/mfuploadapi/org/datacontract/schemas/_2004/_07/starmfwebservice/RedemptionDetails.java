...
public class RedemptionDetails {
    ...
    @XmlElementRef(name = "Amt", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "Nav", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "Unit", namespace = "http://schemas.datacontract.org/2004/07/StarMFWebService", type = JAXBElement.class)
    ...
    public void setAmt(JAXBElement<String> value) {
        this.amt = ((JAXBElement<String> ) value);
    }
    ...
    public void setNav(JAXBElement<String> value) {
        this.nav = ((JAXBElement<String> ) value);
    }
