...
public class GetPasswordForChildOrderResponse {
    ...
    @XmlElementRef(name = "GetPasswordForChildOrderResult", namespace = "http://www.bsestarmf.in/2016/01/", type = JAXBElement.class)
    ...
    public void setGetPasswordForChildOrderResult(JAXBElement<Response> value) {
        this.getPasswordForChildOrderResult = ((JAXBElement<Response> ) value);
    }
