...
public class SpreadOrderEntryParamResponse {
    ...
    @XmlElementRef(name = "spreadOrderEntryParamResult", namespace = "http://bsestarmf.in/", type = JAXBElement.class)
    ...
    public void setSpreadOrderEntryParamResult(JAXBElement<String> value) {
        this.spreadOrderEntryParamResult = ((JAXBElement<String> ) value);
    }
