...
public class SwitchOrderEntryParamResponse {
    ...
    @XmlElementRef(name = "switchOrderEntryParamResult", namespace = "http://bsestarmf.in/", type = JAXBElement.class)
    ...
    public void setSwitchOrderEntryParamResult(JAXBElement<String> value) {
        this.switchOrderEntryParamResult = ((JAXBElement<String> ) value);
    }
