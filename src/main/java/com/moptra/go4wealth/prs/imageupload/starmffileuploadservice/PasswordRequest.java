...
public class PasswordRequest {
    ...
    @XmlElementRef(name = "MemberId", namespace = "http://schemas.datacontract.org/2004/07/StarMFFileUploadService", type = JAXBElement.class)
    protected JAXBElement<String> memberId;
    @XmlElementRef(name = "Password", namespace = "http://schemas.datacontract.org/2004/07/StarMFFileUploadService", type = JAXBElement.class)
