...
public class GoForWealthPRSStringUtil {
	/**
	...
	public static boolean isEmpty(Object obj) {
		boolean isEmpty = false;
		if (obj == GoForWealthPRSConstants.BLANK)
			isEmpty = true;
		return isEmpty;
	}
	...
	public static boolean compareListData(List currentList, List availableList)
	{
		...
		else if(GoForWealthPRSUtil.isEmptyCollection(currentList) && GoForWealthPRSUtil.isEmptyCollection(availableList)){
			return true;
		}
		return false;
	}
