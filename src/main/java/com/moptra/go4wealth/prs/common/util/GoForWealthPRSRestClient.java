...
public class GoForWealthPRSRestClient {

	private static Logger logger = LoggerFactory.getLogger(GoForWealthPRSRestClient.class);


	@SuppressWarnings("unchecked")
	public static Object invokeURL(String url, Object requestObject,Class responsePojo, HttpHeaders headersToSend, HttpMethod httpMethod) throws GoForWealthPRSException {
		...
		try {
			...
			logger.info("Request Entity JSON going to :" + GoForWealthPRSUtil.getJsonFromObject(requestEntity,null));
