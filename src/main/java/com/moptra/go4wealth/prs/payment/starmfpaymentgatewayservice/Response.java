...
public class Response {
    ...
    @XmlElementRef(name = "Filler", namespace = "http://schemas.datacontract.org/2004/07/StarMFPaymentGatewayService", type = JAXBElement.class)
    protected JAXBElement<String> filler;
    @XmlElementRef(name = "ResponseString", namespace = "http://schemas.datacontract.org/2004/07/StarMFPaymentGatewayService", type = JAXBElement.class)
    protected JAXBElement<String> responseString;
    @XmlElementRef(name = "Status", namespace = "http://schemas.datacontract.org/2004/07/StarMFPaymentGatewayService", type = JAXBElement.class)
    ...
    public void setFiller(JAXBElement<String> value) {
        this.filler = ((JAXBElement<String> ) value);
    }
    ...
    public void setResponseString(JAXBElement<String> value) {
        this.responseString = ((JAXBElement<String> ) value);
    }
